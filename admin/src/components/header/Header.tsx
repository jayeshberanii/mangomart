    ...
    <header className="sticky top-0 flex w-full bg-white border-gray-200 z-99 dark:border-gray-800 dark:bg-gray-900 lg:border-b">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          ...
          <Link to={ROUTES.ADMIN} className="lg:hidden">
            <img
              role="none"
              tabIndex={-1}
...
export const UserHeader = () => {
  ...
  return (
    <header className="w-full sticky gap-4 top-0 backdrop-blur-md py-2 text-center border px-2 flex items-start md:items-center justify-between flex-col md:flex-row z-10 border-gray-200">
      <img
        role="none"
        tabIndex={-1}
        className="dark:hidden cursor-pointer"
      ...
      {user ? (
        ...
        <div className={`flex gap-4 py-2`}>
          <CommonButton
            variant="secondary"
            handleClick={() => navigate(ROUTES.SIGN_IN)}
          >
            SignIn
          </CommonButton>
          <CommonButton
            variant="secondary"
            handleClick={() => navigate(ROUTES.SIGN_UP)}
          >
            SignUp
          </CommonButton>
        </div>
